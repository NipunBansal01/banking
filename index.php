...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://image.flaticon.com/icons/png/128/662/662622.png">
    <!-- Bootstrap CSS -->
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="row intro py-1" style="background-color : #0C376A;">
        <div class="col-sm-12 col-md">
          <div class="heading text-center my-5">
            <h1 style="color: #ffffff; ">Welcome to TSF BANK</h1>
          </div>
        </div>
        <div class="col-sm-12 col-md img text-center">
          <img src="img/spark-logo.png" class="img-fluid pt-2">
        </div>
      </div>

      <!-- Activity section -->
      <div class="row activity text-center mt-3">
        ...
        <div class="col-md act">
          <img src="img/transfer-money.jpg" class="img-fluid">
          <br>
    ...
    <footer class="text-center mt-5 py-2">
      <p style="color: #ffffff;">&copy 2022. Made by <b>Nipun Bansal</b></p>
    </footer>
